...
var app = (function () {
    ...
    /* src\components\ChatContainer.svelte generated by Svelte v3.42.1 */
    const file$4 = "src\\components\\ChatContainer.svelte";
    ...
    // (13:4) {#each messages as message}
    function create_each_block(ctx) {
    	let div2;
    	let div0;
    	let t0_value = /*message*/ ctx[3].username + "";
    	let t0;
    	let t1;
    	let div1;
    	let t2_value = /*message*/ ctx[3].message + "";
    	let t2;
    	let t3;
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = text(t2_value);
    			t3 = space();
    			attr_dev(div0, "class", "msg-user svelte-12dfvvk");
    			add_location(div0, file$4, 14, 8, 350);
    			attr_dev(div1, "class", "msg-msg svelte-12dfvvk");
    			add_location(div1, file$4, 15, 8, 406);
    			attr_dev(div2, "class", "message svelte-12dfvvk");
    			add_location(div2, file$4, 13, 6, 319);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*messages*/ 1 && t0_value !== (t0_value = /*message*/ ctx[3].username + "")) set_data_dev(t0, t0_value);
    			if (dirty & /*messages*/ 1 && t2_value !== (t2_value = /*message*/ ctx[3].message + "")) set_data_dev(t2, t2_value);
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(13:4) {#each messages as message}",
    		ctx
    	});
    ...
    function create_fragment$6(ctx) {
    	let div;
    	let if_block = /*messages*/ ctx[0] && create_if_block$1(ctx);

    	const block = {
    		c: function create() {
    			div = element("div");
    			if (if_block) if_block.c();
    			attr_dev(div, "class", "chat-container svelte-12dfvvk");
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<ChatContainer> was created with unknown prop '${key}'`);
    	});

    	function div_binding($$value) {
    		binding_callbacks[$$value ? 'unshift' : 'push'](() => {
    			chatContainer = $$value;
    			$$invalidate(1, chatContainer);
    		});
    	}
    	...
    	$$self.$inject_state = $$props => {
    		if ('messages' in $$props) $$invalidate(0, messages = $$props.messages);
    		if ('chatContainer' in $$props) $$invalidate(1, chatContainer = $$props.chatContainer);
    	};
    	...
    	return [messages, chatContainer, div_binding];
    }
    ...
    class ChatContainer extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*messages*/ ctx[0] === undefined && !('messages' in props)) {
    			console.warn("<ChatContainer> was created without expected prop 'messages'");
    		}
    	}

    	get messages() {
    		throw new Error("<ChatContainer>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set messages(value) {
    		throw new Error("<ChatContainer>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    }
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "card svelte-eufzog");
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			if (default_slot) default_slot.c();
    			attr_dev(div, "class", "container svelte-15nec9j");
    ...
    const updateMessages = (username, room, message) => {
      messages.update(messages => ({
        ...messages,
        [room]: [...messages[room], { username, message }]
      }));
    };
    ...
    socket.on("broadcast-msg", (data) => {
      ...
      updateMessages(username, "Lounge", message);
    });

    /* src\screens\Home.svelte generated by Svelte v3.42.1 */
    ...
    function create_default_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div1 = element("div");
    			div0 = element("div");
    			div0.textContent = "The Lounge";
    			t1 = space();
    			button0 = element("button");
    			button0.textContent = "Leave";
    			t3 = space();
    			...
    			attr_dev(div0, "class", "home-title svelte-ni5qvm");
    			add_location(div0, file$1, 44, 6, 1003);
    			attr_dev(button0, "class", "leave-btn svelte-ni5qvm");
    			add_location(button0, file$1, 45, 6, 1051);
    			attr_dev(div1, "class", "home-header svelte-ni5qvm");
    			add_location(div1, file$1, 43, 4, 970);
    			attr_dev(input, "class", "send-msg-input svelte-ni5qvm");
    			attr_dev(input, "placeholder", "Enter a message");
    			add_location(input, file$1, 49, 6, 1204);
    			attr_dev(button1, "class", "send-btn svelte-ni5qvm");
    			add_location(button1, file$1, 58, 6, 1452);
    			attr_dev(div2, "class", "form-container svelte-ni5qvm");
    			add_location(div2, file$1, 48, 4, 1168);
    		},
    		m: function mount(target, anchor) {
    			...
    			mount_component(chatcontainer, target, anchor);
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(input, "keypress", /*keypress_handler*/ ctx[7], false, false, false),
    					listen_dev(button1, "click", /*sendMessage*/ ctx[4], false, false, false)
    				];
    		...
    		p: function update(ctx, dirty) {
    			const chatcontainer_changes = {};
    			if (dirty & /*msgs*/ 1) chatcontainer_changes.messages = /*msgs*/ ctx[0];
    			chatcontainer.$set(chatcontainer_changes);
    		...
    		d: function destroy(detaching) {
    			...
    			destroy_component(chatcontainer, detaching);
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*$$scope, inputRef, message, msgs*/ 1031) {
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	let $myUsername;
    	validate_store(myUsername, 'myUsername');
    	component_subscribe($$self, myUsername, $$value => $$invalidate(9, $myUsername = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    	...
    	function logout() {
    		loginOb.updateLogin(false);
    	}

    	function sendMessage() {
    		if (message) {
    			socket.emit("new-msg", { username: $myUsername, message });
    			updateMessages($myUsername, "Lounge", message);
    	...
    	onMount(() => {
    		sub = messages.subscribe(val => {
    			$$invalidate(0, msgs = val["Lounge"]);
    		});

    		socket.emit("send-welcome-msg", $myUsername);
    		inputRef.focus();
    	});
    	...
    	$$self.$inject_state = $$props => {
    		if ('msgs' in $$props) $$invalidate(0, msgs = $$props.msgs);
    ...
    /* src\screens\Login.svelte generated by Svelte v3.42.1 */
    const file = "src\\screens\\Login.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div1 = element("div");
    			div0 = element("div");
    			div0.textContent = "Chat App";
    			t1 = space();
    			input = element("input");
    			t2 = space();
    			button = element("button");
    			button.textContent = "Enter";
    			attr_dev(div0, "class", "title svelte-187jwg5");
    			add_location(div0, file, 20, 4, 408);
    			attr_dev(input, "type", "text");
    			attr_dev(input, "placeholder", "Username");
    			attr_dev(input, "class", "svelte-187jwg5");
    			add_location(input, file, 23, 4, 461);
    			attr_dev(button, "class", "svelte-187jwg5");
    			add_location(button, file, 32, 4, 671);
    			attr_dev(div1, "class", "login-card svelte-187jwg5");
    			add_location(div1, file, 19, 2, 378);
    			attr_dev(div2, "class", "login-page svelte-187jwg5");
    			add_location(div2, file, 18, 0, 350);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input, /*$myUsername*/ ctx[1]);
    			append_dev(div1, t2);
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*$myUsername*/ 2 && input.value !== /*$myUsername*/ ctx[1]) {
    				set_input_value(input, /*$myUsername*/ ctx[1]);
    			}
    		},
    		i: noop,
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	let $myUsername;
    	validate_store(myUsername, 'myUsername');
    	component_subscribe($$self, myUsername, $$value => $$invalidate(1, $myUsername = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    	...
    	function login() {
    		if ($myUsername) {
    			loginOb.updateLogin(true);
    			socket.emit("new-connection", { username: $myUsername });
    		}
    	}
    ...
    /* src\screens\Auth.svelte generated by Svelte v3.42.1 */
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const unsub = loginOb.subscribe(val => {
    		$$invalidate(0, loginStatus = val);
    	});
    	...
    	$$self.$inject_state = $$props => {
    		if ('loginStatus' in $$props) $$invalidate(0, loginStatus = $$props.loginStatus);
    	};
